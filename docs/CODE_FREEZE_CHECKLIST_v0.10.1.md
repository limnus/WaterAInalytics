# Code freeze checklist — v0.10.1

Use this checklist before creating the consolidated `v0.10.1` tag.

## A. Code and configuration
- [ ] `core/version.py` shows `v0.10.1`
...
- [ ] shared exports and article bundles do not leak local absolute paths
...
- [ ] `docs/REPRODUCIBILITY_v0.10.1.md` is current
- [ ] `docs/RUNBOOK_v0.10.1.md` is current
- [ ] `docs/CODE_FREEZE_CHECKLIST_v0.10.1.md` is current
- [ ] `docs/RELEASE_VALIDATION_v0.10.1.md` is current
- [ ] `CHANGELOG.md` includes `v0.10.1` stabilization steps
...
```bash
git tag -a v0.10.1 -m "WaterAInalytics v0.10.1 - post-v0.10.0 stabilization, article-mode hardening, export path sanitization, and auth UX cleanup"
