...
BRIEF = {
    ...
    "key_findings": ["Recent variability is low.", "The latest observation is close to the recent mean."],
    "forecast_interpretation": ["The next predicted value is slightly above the latest observation."],
...
def test_render_quantitative_brief_narrative_is_flowing_text():
    ...
    assert "Observed-series interpretation:" in md
